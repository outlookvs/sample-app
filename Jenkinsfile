        ...
        stage('Build') {
            steps {
                ...
                container('docker'){
                    ...
                    // sh "docker run --rm dinutac/jinja2docker:latest $WORKSPACE/templates/templates.json $WORKSPACE/variables/vars.json"
                    sh "docker run --rm dinutac/jinja2docker:latest ./templates/templates.json ./variables/vars.json"
                    sh "ls -ltr"
                }
