        ...
        stage('Build') {
            steps {
                ...
                container('docker-compose'){
                    ...
                    sh "mkdir out"
                    sh "echo $PWD"
                    sh "docker run --rm -v $PWD/templates:/templates -v $PWD/variables:/variables -v $PWD/out:/out dinutac/jinja2docker:latest /templates/template.json /variables/vars.json \\> /out/result.json"
                    sh "ls -ltr"
                }
